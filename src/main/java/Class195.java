				...
				if (Node_Sub38_Sub8.anInt10163 == 8) {
					...
					if (Class159.loginType == 2) { // world login
						...
						if (!FixedAnimator.aBoolean5503) { //not social network
							packet.writeInt(667);
							packet.writeInt(ClientConstants.getIntegerVersion());
						...
						BufferedStream buffer_39_ = new BufferedStream(Node_Sub23.aNode_Sub39_7201.method2923((byte) 66));
					...
					if (Node_Sub38_Sub8.anInt10163 == 14) {
						...
						if (Class159.loginType != 2) {
							...
							if (Class240.aClass329_2943 != Node_Sub38_Sub1.aClass329_10086) {
								Class262_Sub23.aClass197_7884.firstPort = ClientConstants.GAME_SERVER_PORT;// 40000
								// -
