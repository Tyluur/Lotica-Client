...
public class Node_Sub42 extends Node {
	...
	static final void method2936(GraphicsToolkit graphicstoolkit, int i) {
		...
		graphicstoolkit.aa(i_1_, i_2_, Class360.screenWidth, 350, Settings.DEV_CONSOLE_COLOR | Class298.anInt3740 << 24, 1);
		...
		if ((Class144_Sub4.anInt6848 ^ 0xffffffff) < -1) {
			...
			graphicstoolkit.aa(-16 + (i_1_ - -Class360.screenWidth), i_2_ + i_6_, 12, i_5_, Class298.anInt3740 << 24 | Settings.DEV_CONSOLE_COLOR, 2);
