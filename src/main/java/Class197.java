...
public class Class197 {
	...
	protected int secondPort = ClientConstants.GAME_SERVER_PORT;
	protected int firstPort = ClientConstants.GAME_SERVER_PORT;
	...
	// the way other connections are made
	...
	final Class241 createUpdateServer(SignLink signlink) {
		anInt2418++;
		return signlink.method3629(ClientConstants.UPDATE_SERVER_IP, true, aBoolean2414, ClientConstants.UPDATE_SERVER_PORT);
	}
	...
	public Class197() {
		secondPort = ClientConstants.GAME_SERVER_PORT;
		aBoolean2414 = false;
		aBoolean2420 = true;
	}
}
