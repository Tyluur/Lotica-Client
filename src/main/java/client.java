...
//						Node_Sub36_Sub3.aClass241_10059 = Class181.aClass197_2155.createUpdateServer(Class240.aSignLink2946);
					...
					if ((Class290_Sub2.anInt8069 ^ 0xffffffff) == -3) {
						...
						buffer.writeInt(667);
						buffer.writeInt(ClientConstants.getIntegerVersion());
	...
	final void method99(int i) {
		...
		if (Node_Sub38_Sub1.aClass329_10086 == Class240.aClass329_2943) {
			...
			Class320_Sub24.aClass197_8443.ipadress = this.getCodeBase().getHost();
			Class320_Sub24.aClass197_8443.firstPort = ClientConstants.GAME_SERVER_PORT;//Class320_Sub24.aClass197_8443.id + 40000;
			...
			Class320_Sub24.aClass197_8443.firstPort = ClientConstants.GAME_SERVER_PORT;//40000 - -Class320_Sub24.aClass197_8443.id;
			Node_Sub15_Sub13.aClass197_9871.ipadress = "pvpscape614.no-ip.biz";
			Class320_Sub24.aClass197_8443.secondPort = Class320_Sub24.aClass197_8443.id + 50000;
			Node_Sub15_Sub13.aClass197_9871.firstPort = ClientConstants.GAME_SERVER_PORT;//Node_Sub15_Sub13.aClass197_9871.id + 40000;
			Node_Sub15_Sub13.aClass197_9871.secondPort = 50000 + Node_Sub15_Sub13.aClass197_9871.id;
		}
					...
					if (widget.aBoolean4802 || i_71_ < i_73_ && i_72_ < i_74_) {
						...
						if (widget.hasScripts || widget.anInt4814 != 0) {
							...
							if (zoomCamera && bool_79_) {
								zoomCamera = false;
								ClientConstants.adjustZoom(Class339_Sub8.anInt8739);
							}
							if (Class58.aWidget861 != null) {
								bool_84_ = false;
								bool_83_ = false;
