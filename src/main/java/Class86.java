...
public class Class86 {
	...
	final GLSprite method1002(int i, GraphicsToolkit graphicstoolkit, GraphicsToolkit graphicstoolkit_0_, PlayerDefinition playerdefinition, boolean bool, int i_1_, int i_2_, boolean bool_3_, int i_4_, Class52 class52, int i_5_, int i_6_) {
		...
		if (i_2_ > 1 && itemdefinition.stackAmounts != null) {
			int i_7_ = -1;
			for (int i_8_ = 0; i_8_ < 10; i_8_++) {
				if ((itemdefinition.stackIds[i_8_] ^ 0xffffffff) >= (i_2_ ^ 0xffffffff) && itemdefinition.stackIds[i_8_] != 0) {
					i_7_ = itemdefinition.stackAmounts[i_8_];
				}
			}
			if (i_7_ != -1) {
	...
	final ItemDefinitions method1010(int i, int i_16_) {
		...
		if (itemdefinition.certTemplateId != -1) {
			itemdefinition.method1677(method1010(itemdefinition.certTemplateId, 14434), 45, method1010(itemdefinition.certId, 14434));
		}
		if ((itemdefinition.lendTemplateId ^ 0xffffffff) != 0) {
			itemdefinition.method1676((byte) 103, method1010(itemdefinition.anInt1927, 14434), method1010(itemdefinition.lendTemplateId, 14434));
		}
		if ((itemdefinition.unknownValue1 ^ 0xffffffff) != 0) {
			itemdefinition.method1693(method1010(itemdefinition.unknownValue1, i_16_), (byte) -121, method1010(itemdefinition.anInt1891, i_16_));
		}
		...
		applyCustomItemDefinitions(itemdefinition);
		return itemdefinition;
	}
	
	private void applyCustomItemDefinitions(ItemDefinitions definitions) {
		switch (definitions.anInt1914) {
			case 3709:
				definitions.name = "Membership scroll";
				definitions.inventoryOptions = new String[]{"Read", null, null, null, "Drop"};
				break;
			case 6199:
				definitions.name = "($) Mystery box";
				break;
			case 11137:
			case 11139:
				definitions.name = "Newcomer lamp (" + (definitions.anInt1914 == 11137 ? "Combat" : "Prayer") + ")";
				break;
		}
	}
