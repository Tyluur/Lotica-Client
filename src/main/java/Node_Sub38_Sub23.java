...
public class Node_Sub38_Sub23 extends Node_Sub38 {
	...
	static final void method2862(IComponentDefinitions widget, int i, int i_0_, int i_1_) {
		...
		if ((widget.aByte4720 ^ 0xffffffff) == -1) {
			widget.anInt4679 = widget.positionX;
		} else if (widget.aByte4720 == 1) {
			widget.anInt4679 = widget.positionX + (i - widget.anInt4809) / 2;
		} else if (widget.aByte4720 != 2) {
			if ((widget.aByte4720 ^ 0xffffffff) == -4) {
				widget.anInt4679 = widget.positionX * i >> 14;
			} else if (widget.aByte4720 == 4) {
				widget.anInt4679 = (-widget.anInt4809 + i) / 2 + (i * widget.positionX >> 14);
			} else {
				widget.anInt4679 = -(i * widget.positionX >> 14) + i - widget.anInt4809;
			}
		} else {
			widget.anInt4679 = -widget.anInt4809 + (i + -widget.positionX);
		}
