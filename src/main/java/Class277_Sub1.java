		...
		if ((Class213.aNode_Sub27_2512.aClass320_Sub19_7301.method3751(false) ^ 0xffffffff) != -1 || Class369.method4085(i_49_, 0, Class94.anInt1249, i_50_, i_53_)) {
			...
			if (Class213.aNode_Sub27_2512.aClass320_Sub30_7275.method3796(false) != 0 || !objectdefinition.aBoolean2990) {
				...
				if ((i_51_ ^ 0xffffffff) != -2 && i_51_ != 3) {
					i_57_ = objectdefinition.sizeX;
					i_56_ = objectdefinition.sizeY;
				} else {
					i_56_ = objectdefinition.sizeX;
					i_57_ = objectdefinition.sizeY;
				}
				int i_58_;
				int i_59_;
		...
		for (; ; ) {
			...
			for (; ; ) {
				...
				if ((i_124_ ^ 0xffffffff) == (i_132_ ^ 0xffffffff) && i <= i_131_ && (i_131_ ^ 0xffffffff) > (i + 8 ^ 0xffffffff) && i_125_ <= i_130_ && i_130_ < 8 + i_125_) {
					...
					int i_136_ = Class32.method354(objectdefinition.sizeX, 0x7 & i_130_, (byte) 45, objectdefinition.sizeY, i_135_, i_131_ & 0x7, i_123_) + i_121_;
					int i_137_ = Class275.method3336(i_123_, 0x7 & i_130_, objectdefinition.sizeY, i_135_, objectdefinition.sizeX, i_131_ & 0x7, 104) + i_122_;
		...
		if (interface19 != null) {
			...
			if (i != 0) {
				if (i == 1) {
					...
					if (objectdefinition.anInt3010 != 0 && (anInt3524 ^ 0xffffffff) < (objectdefinition.sizeX + i_162_ ^ 0xffffffff) && anInt3521 > objectdefinition.sizeX + i_160_ && i_162_ + objectdefinition.sizeY < anInt3524 && objectdefinition.sizeY + i_160_ < anInt3521) {
						class84.method992(objectdefinition.aBoolean3034, !objectdefinition.aBoolean3016, (byte) -106, i_162_, objectdefinition.sizeX, objectdefinition.sizeY, i_164_, i_160_);
					}
