	...
	static final void method1580(int i, int i_2_, CacheNode_Sub13 cachenode_sub13, int i_3_) {
		...
		if (cachenode_sub13 != null && cachenode_sub13 != Class368.aClass312_4549.aNode3958) {
			...
			if ((i_6_ ^ 0xffffffff) == -45) {
				Player player = Class270_Sub2.LOCAL_PLAYERS[npcIndex];
				if (player != null) {
					...
					node_sub13.aPacket7113.writeShortLE(npcIndex);
					node_sub13.aPacket7113.writeIntLE(Node_Sub15_Sub9.anInt9839);
					node_sub13.aPacket7113.writeShort(Class92.anInt1230);
					node_sub13.aPacket7113.write128Byte(!Class175.aClass291_2100.isKeyHeld(93, 82) ? 0 : 1);
			...
			if ((i_6_ ^ 0xffffffff) == -5) {
				...
				node_sub13.aPacket7113.writeIntLE(Node_Sub15_Sub9.anInt9839);
				node_sub13.aPacket7113.writeShort(Class92.anInt1230);
				node_sub13.aPacket7113.write128Byte(Class175.aClass291_2100.isKeyHeld(i_2_ ^ ~0x20, 82) ? 1 : 0);
				node_sub13.aPacket7113.writeShortLE128(Class46.anInt681);
			...
			if (i_6_ == 12) {
				...
				if (i_6_ == 58) {
					if ((Class339_Sub7.rights ^ 0xffffffff) >= -1 || !Class175.aClass291_2100.isKeyHeld(119, 82) || !Class175.aClass291_2100.isKeyHeld(i_2_ ^ 0x6a, 81)) {
						...
						Node_Sub13 node_sub13 = Class22.createWalkPacket(steps, npcIndex);
						if (npcIndex == 1) {
							...
							node_sub13.aPacket7113.writeShort(Class295.myPlayer.y);
							node_sub13.aPacket7113.writeShort(Class295.myPlayer.x);
				...
				if (class318 != null) {
					...
					if (player != null) {
						...
						node_sub13.aPacket7113.writeByte(Class175.aClass291_2100.isKeyHeld(-42, 82) ? 1 : 0);
						node_sub13.aPacket7113.writeShort(npcIndex);
				...
				if (class318_8_ != null) {
					...
					node_sub13.aPacket7113.writeShort128(npcIndex);
					node_sub13.aPacket7113.writeByte(!Class175.aClass291_2100.isKeyHeld(94, 82) ? 0 : 1);
				...
				if (class318_9_ != null) {
					Node_Sub41 node_sub41 = (Node_Sub41) Class12.aHashTable187.method1518(3512, (long) npcIndex);
					if (node_sub41 != null) {
						Class93_Sub2.anInt6067 = i_3_;
						...
						node_sub13.aPacket7113.writeByte128(!Class175.aClass291_2100.isKeyHeld(i_2_ ^ 0x54, 82) ? 0 : 1);
						node_sub13.aPacket7113.writeShort128(npcIndex);
						Class218.aClass123_2566.sendPacket(126, node_sub13);
				...
				if (class318_10_ != null) {
					if (class318_10_ != Animable_Sub2.aClass318_9114) {
						int steps;
						...
						if (routeType != 10 && routeType != 11 && (routeType ^ 0xffffffff) != -23) {
							...
							steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, objectdefinition.method3051(i_5_), Class295.myPlayer.getSize((byte) 0), 0, true, sizeX, sizeY, i_8_, 0, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);
					...
					node_sub13.aPacket7113.writeByte128(Class175.aClass291_2100.isKeyHeld(99, 82) ? 1 : 0);
				...
				if ((~i_6_) == -18) {
					...
					node_sub13.aPacket7113.writeByte(!Class175.aClass291_2100.isKeyHeld(125, 82) ? 0 : 1);
					node_sub13.aPacket7113.writeShortLE(npcIndex);
					Class218.aClass123_2566.sendPacket(127, node_sub13);
					Class223.method2104(0, i_5_, i_4_);
				}
				if ((i_6_ ^ 0xffffffff) == -24) {
					...
					if (node_sub41 != null) {
						...
						node_sub13.aPacket7113.writeShortLE(npcIndex);
						node_sub13.aPacket7113.writeIntV2(Node_Sub15_Sub9.anInt9839);
						node_sub13.aPacket7113.writeByte(!Class175.aClass291_2100.isKeyHeld(-40, 82) ? 0 : 1);
						Class218.aClass123_2566.sendPacket(127, node_sub13);
				...
				if (i_6_ == 60) {
					...
					if (routeType != 10 && routeType != 11 && (routeType ^ 0xffffffff) != -23) {
						...
						int blah = objectdefinition.anInt3040;
						if (rotation != 0) {
							blah = (0xf & blah << rotation) - -(blah >> -rotation + 4);
						}
						steps = Class275.calculateRoute(Class295.myPlayer.scenePositionXQueue[0], Class295.myPlayer.scenePositionYQueue[0], i_4_, i_5_, Class295.myPlayer.getSize((byte) 0), 0, true, sizeX, sizeY, blah, 0, Class304.SCENE_CLIP_DATA_PLANES[Class295.myPlayer.plane], Class328_Sub1.calculatedScenePositionXs, Class258.calculatedScenePositionYs, (byte) -41);
					}
					Node_Sub13 packet = Class22.createWalkPacket(steps, 0);
					Class218.aClass123_2566.sendPacket(126, packet);
					...
					node_sub13.aPacket7113.writeByteC(Class175.aClass291_2100.isKeyHeld(-61, 82) ? 1 : 0);
