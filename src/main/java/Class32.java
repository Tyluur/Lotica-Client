		...
		while (buffer.offset < i_9_) {
			...
			if (opcode == 3) {
				...
				if (cachenode_sub9.stringValues[count].contains("Error connecting to server.")) {
					cachenode_sub9.stringValues[count] = cachenode_sub9.stringValues[count].replace("Error connecting to server.", "Error connecting to " + ClientConstants.NAME + ".");
				}
				if (cachenode_sub9.stringValues[count].toLowerCase().contains("notes (")) { //test pls unhide the cid
					cachenode_sub9.stringValues[count] = "Journals<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
				}
			} else if (opcode != 54) {
