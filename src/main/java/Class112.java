...
public class Class112 {
	...
	final ObjectDefinition method1145(int i, int i_1_) {
		...
		applyCustomObjectDefinitions(objectdefinition);
		synchronized (aClass61_1427) {
	...
	private void applyCustomObjectDefinitions(ObjectDefinition definition) {
		switch (definition.objectId) {
			case 11231:
				definition.aString2999 = "Key Chest";
				definition.aStringArray2980 = new String[]{"Open", null, null, null, null, "Examine"};
				break;
		}
	}
